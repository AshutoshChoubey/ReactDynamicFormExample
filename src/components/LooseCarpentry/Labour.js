...
<button type="button" className="btn btn-primary text-center">Order</button>
</div>
<div className="col-sm-2">
<button type="button" onClick={()=>this.props.addLabour()} className="btn btn-primary text-center">+</button>
</div>
</div>
